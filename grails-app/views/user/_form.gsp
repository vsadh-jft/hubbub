<%@ page import="com.grailsinaction.SUser" %>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'userId', 'error')} required">
	...
	<g:textField name="userId" maxlength="10" required="" value="${userInstance?.userId}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'password', 'error')} ">
	...
	<g:textField name="password" required="true" maxlength="8" value="${userInstance?.password}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'following', 'error')} ">
	...
	<g:select name="following" from="${com.grailsinaction.SUser.list()}" multiple="multiple" optionKey="id" size="5" value="${userInstance?.following*.id}" class="many-to-many"/>
</div>

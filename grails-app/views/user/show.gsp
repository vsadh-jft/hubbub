...
<%@ page import="com.security.SUser" %>
<!doctype html>
<html>
	<head>
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="userId-label" class="property-label"><g:message code="user.userId.label" default="User Id" /></span>
						...
						<span class="property-value" aria-labelledby="userId-label"><g:fieldValue bean="${userInstance}" field="username"/></span>
				...
				<li class="fieldcontain">
					<span id="profile-label" class="property-label"><g:message code="user.profile.label" default="Profile" /></span>
						...
						<span class="property-value" aria-labelledby="profile-label"><g:link controller="profile" action="show" id="${userInstance?.profile?.id}">Link</g:link></span>
				...
				<li class="fieldcontain">
					...
					<g:set var="defe" value= "${userInstance.following.sort{it.id}}"></g:set>
                    <g:each in="${defe}" var="t">
						<span class="property-value" aria-labelledby="following-label"><g:link controller="user" action="show" id="${t.id}">${t.profile.fullName?.encodeAsHTML()}</g:link></span>
						</g:each>
